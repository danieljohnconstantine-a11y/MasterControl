# Unified column order - 54 unique fields across Groups A, B, and C
COLUMN_ORDER = [
    # Core identification fields (first 4)
    "Track", "Race_No", "Box", "Dog_Name",
    # Group A – Identification (9 more fields)
    "Tab_No", "FF_Form", "A/S", "WT (kg)", "Trainer", "Sire", "Dam", "Owner",
    # Group B – Career Stats (26 fields)
    ...
    "Avg_Speed_km/h", "Min_Speed_km/h", "Max_Speed_km/h",
