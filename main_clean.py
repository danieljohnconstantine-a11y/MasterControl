...
Clean implementation using modular architecture.
"""
import sys
import os
...
from read_docx_clean import read_all_docx
from parse_docx_clean import parse_all_docx
from aggregate_history_clean import aggregate_history
from export_to_excel_clean import merge_and_export
from validation_and_audit_clean import (
    write_parse_audit,
...
def main():
    ...
    print("=" * 60)
    print("DOCX to Excel/CSV Pipeline - Clean Architecture")
    print("=" * 60)
